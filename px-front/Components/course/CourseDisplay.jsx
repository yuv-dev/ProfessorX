...
const CourseDisplay = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`bg-linear-0 from-transparent to-blue-100 p-8 pt-0 rounded-xl space-y-10 overflow-hidden ${!isEnrolled ? "h-70" : " "} `}
      >
        <div>
          {!isEnrolled && (
            <div className="text-center p-6 bg-white rounded-lg border border-gray-200 shadow-md">
              <h3 className="text-2xl font-bold mb-4">
                <LockKeyholeIcon size={48}/>Enroll to Access Full Course Content
              </h3>
